...
const { userCreate, userForId, allUserForNucleo, updateUser, deleteUser, optionsUsers, ageismController, sexoismController, studyismController, ethnicismController } = require('../controllers/Usuario');
const router = Router();
